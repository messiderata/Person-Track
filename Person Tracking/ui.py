...
# Global variables for COM port and movement increment
com_port = None
movement_increment = 2  # Fixed movement increment
        ...
        for r in results:
            ...
            if bounding_boxes:
                ...
                if x_center < camera_center - center_threshold:  # Object is to the left of the center
                    servo_angle += movement_increment
...
class App(ctk.CTk):
    def __init__(self):
        ...
        self.result_label2 = ctk.CTkLabel(
            master=button_frame2,
            text="COM Port:",
            fg_color="transparent",
            text_color="white",
        ...
        self.result_label2.pack(pady=5, padx=10, expand=True)

        self.optionmenu_3 = ctk.CTkComboBox(
            button_frame2,
            fg_color="#fed32c",
            text_color="#20242a",
            button_color="#fed32c",
        ...
        self.optionmenu_3.pack(pady=10)
        ...
        # Set the global com_port to the first detected port if available
    ...
    def print_combo_box(self):
        ...
        global com_port
        com_port = self.optionmenu_3.get()
        Run(source, conf)
...
def Run(source, conf):
    global arduino
    arduino = serial.Serial(com_port, 115200, timeout=1)  # Update the COM port based on user selection
